...
('Why should I choose Auto Pavilion over other dealers?', 'We offer an uncompromised comprehensive quality check, verified history records, transparent legal paperwork, and access to an exclusive ''Recently Sold'' premium collection. Our sourcing service ensures a seamless, premium buying experience.', 'General', array['why choose', 'why you', 'special', 'different', 'best dealer', 'trust', 'reliability'], 9),
...
('Do you sell cars that have been in accidents?', 'No. We conduct thorough structural checks on all vehicles in our collection. We only select vehicles that meet our high standards of body integrity, backed by transparent documentation.', 'Vehicle Inspection', array['accident', 'crashed', 'damaged', 'structural', 'totaled', 'rebuilt'], 6),
